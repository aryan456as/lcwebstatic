...
const FloatingButtons = () => {
  const phoneNumber = '+918400065000' // Replace with actual phone number
  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
      <div className="relative group">
        <motion.button
          className="bg-[#800000] text-white p-3 rounded-full shadow-lg hover:bg-[#FFA500] transition-colors"
          onClick={handleCall}
